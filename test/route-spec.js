    ...
    it('should have all routes',() =>{
      return chai.request(server)
        ...
        .then((res) => {
          ...
          res.body.should.have.key(['getAllgames','getGamesForLoggedInUser', 'register', 'login', 'getLoggedInUser', 'getFriendsForLoggedInUser', 'getWordsForSpecifiedGame', 'getWord'])
        })
    })
  });
